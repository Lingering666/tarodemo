...
import MyMusic from './music/musicComponent'
import MyNetease from './netease/neteaseComponent'
// 通过import 语句引入静态文件, 特别说明的是本地图片在使用前一定要引入
import './contentComponent.less'
...
export default class ContentComponent extends Component {
    ...
    config = {
        navigationBarTitleText: '',//将会是页面的标题
    };
    ...
    render() {
        ...
        return (
            <ScrollView className='content' scrollX scrollWithAnimation={true} >
              <MyMusic/>
              <MyNetease/>
            </ScrollView>
        )
