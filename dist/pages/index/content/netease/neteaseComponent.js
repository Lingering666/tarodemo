 ...
 */
var ClassName = function (_BaseComponent) {
  _inherits(ClassName, _BaseComponent);
  ...
  function ClassName() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ClassName.__proto__ || Object.getPrototypeOf(ClassName)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ClassName, [{
    ...
    value: function _constructor(props) {
      _get(ClassName.prototype.__proto__ || Object.getPrototypeOf(ClassName.prototype), "_constructor", this).call(this, props);
    }
...
Component(require('../../../../npm/@tarojs/taro-weapp/index.js').default.createComponent(ClassName));