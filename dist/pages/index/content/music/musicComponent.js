 ...
 */
var MusicComponent = function (_BaseComponent) {
  _inherits(MusicComponent, _BaseComponent);
  ...
  function MusicComponent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MusicComponent.__proto__ || Object.getPrototypeOf(MusicComponent)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(MusicComponent, [{
    ...
    value: function _constructor(props) {
      _get(MusicComponent.prototype.__proto__ || Object.getPrototypeOf(MusicComponent.prototype), "_constructor", this).call(this, props);
    }
...
MusicComponent.properties = {};
MusicComponent.$$events = [];
exports.default = MusicComponent;

Component(require('../../../../npm/@tarojs/taro-weapp/index.js').default.createComponent(MusicComponent));