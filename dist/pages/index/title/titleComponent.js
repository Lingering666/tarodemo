...
var music = "/asset/icon/white/music-top.png";
var category = "/asset/icon/white/category.png";
var netease = "/asset/icon/white/netease.png";
var search = "/asset/icon/white/search.png";
var play = "/asset/icon/white/play-mp4.png";
...
var TitleComponent = function (_BaseComponent) {
  _inherits(TitleComponent, _BaseComponent);
  ...
  function TitleComponent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TitleComponent.__proto__ || Object.getPrototypeOf(TitleComponent)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["category", "music", "netease", "play", "search"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(TitleComponent, [{
    ...
    value: function _constructor(props) {
      _get(TitleComponent.prototype.__proto__ || Object.getPrototypeOf(TitleComponent.prototype), "_constructor", this).call(this, props);
    }
    ...
    value: function showMenu() {
      _index2.default.showToast(_extends({}, toast, {
        title: '你点击了menu'
      })).then();
    }
  }, {
    key: "showMusic",
    value: function showMusic() {
      _index2.default.showToast(_extends({}, toast, {
        title: '你点击了音乐'
      })).then();
    }
...
TitleComponent.properties = {};
TitleComponent.$$events = ["showMenu", "showMusic"];
...
Component(require('../../../npm/@tarojs/taro-weapp/index.js').default.createComponent(TitleComponent));